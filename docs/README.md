...
| [Output storage](output-storage.md) | Private artifact identity, supervisor archival, fenced publication and verified reads | How output is archived, authorized, retrieved and streamed; remaining cleanup work |

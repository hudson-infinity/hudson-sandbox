...
| [Output storage](output-storage.md) | Private artifact identity, conditional writes, fenced publication and verified reads | What retained-output storage implements and what integration remains |

...
| [Operation retention](operation-retention.md) | Terminal response expiry, stable retries and operator policy | How expired results behave and what evidence compaction must preserve |

...
| [Output storage](output-storage.md) | Private artifact identity, conditional writes, verified reads and bounds | What retained-output storage implements and what integration remains |

...
These are host-to-guest methods. Controller-to-supervisor file fencing and authenticated public upload/download routes are still being implemented under [issue #62](https://github.com/hudson-infinity/hudson-sandbox/issues/62). A working private guest client is not a public file API.
